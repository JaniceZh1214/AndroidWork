...
public class RoundImageView extends ImageView {
    ...
    private void setUpShader() {
        ...
        float dx = 0;
        float dy = 0;
        if (bmp.getWidth() * mRoundRect.height() > mRoundRect.width() * bmp.getHeight()) {
            scale = mRoundRect.height() / (float) bmp.getHeight();
            dx = (mRoundRect.width() - bmp.getWidth() * scale) * 0.5f;
        } else {
            scale = mRoundRect.width() / (float) bmp.getWidth();
            dy = (mRoundRect.height() - bmp.getHeight() * scale) * 0.5f;
        }
